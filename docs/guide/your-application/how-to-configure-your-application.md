...
| Public / Private / End-to-End | Define the visibility of the value your field. Public means that your data is stored in the blockchain and visible by everyone. Private allows your field to be observed by users in the chain but also the operator. End-to-End allows your field to be observed *only* by the users in the chain. |
