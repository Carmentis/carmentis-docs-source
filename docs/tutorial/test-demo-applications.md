...
completely transparent for you, thanks to our [wallet](../architecture.md).
...
### Step 3: Access to the demo applications
To access the demo applications, go to the `Applications` section, open an application and click on "Open". 
You will be automatically redirected to the demo application.
